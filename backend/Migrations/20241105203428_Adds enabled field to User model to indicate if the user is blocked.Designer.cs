...
namespace backend.Migrations
{
    ...
    [Migration("20241105203428_Adds enabled field to User model to indicate if the user is blocked")]
    partial class AddsenabledfieldtoUsermodeltoindicateiftheuserisblocked
    {
        /// <inheritdoc />
